...
export function SellerMessageList({ messages: initialMessages = [], buyer, orderId }) {
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Communication history between you and the buyer</CardDescription>
      </CardHeader>
      <CardContent>
                  ...
                  <div className="flex items-center gap-2 mb-2">
                    {message.sender === "buyer" && (
                      <div className="h-8 w-8 rounded-full overflow-hidden">
                        <Image
                          src={buyer?.avatar || "/placeholder.svg?height=32&width=32"}
                    ...
                    <div>
                      <p className="text-sm font-medium">
                        {message.sender === "seller" ? "You" : buyer?.name || "Buyer"}
                      </p>
                      <p
                        className={`text-xs ${message.sender === "seller" ? "text-primary-foreground/70" : "text-muted-foreground"}`}
                      >
